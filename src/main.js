...
arrows.addEventListener("click", () => {
  const change = originalLanguage.value;
  originalLanguage.value = translatedLanguage.value;
  translatedLanguage.value = change;

  if(translatedLanguage.value === "") {
    translatedLanguage.value = "Español";
  }
});
